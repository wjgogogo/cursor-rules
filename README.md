...
### 设计系统
- **JSON 配置**：从界面截图提取设计元素，生成标准化配置
- **颜色系统**：主色、辅助色、中性色、语义色完整定义
- **排版系统**：字体族、字体大小、字重、行高层级规范
- **组件规范**：按钮、输入框、卡片等组件的样式和状态定义
- **布局系统**：响应式断点、栅格系统、间距规范
- **AI 指导**：作为设计指导文档，帮助 AI 生成一致风格的代码

> 💡 **参考资源**：设计系统开发方法论参考 [3 Ways to Build Beautiful Websites Using Cursor AI](https://www.youtube.com/watch?v=djDZHAi75dk)
